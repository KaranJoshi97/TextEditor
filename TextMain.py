...
# Class that will be used to find dialog, setting parameters
...
# Will inherit main menu from menu
class MainMenu(Menu):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.file.add_command(label='Open', accelerator="Ctrl+0", image=self.open_icon, compound=LEFT,
        ...
        self.file.add_command(label='Exit', image=self.exit_icon, compound=LEFT, command=self.parent.exitFunc)
        ...
        self.color_list = {
            # First = font color, second is background color
        ...
        # Creating the string variable and radiobuttons
        ...
        self.add_cascade(label='Template', menu=self.themes)
...
class ToolBar(Label):
    def __init__(self, parent, *args, **kwargs):
        ...
        buttonBold = Button(self, image=self.boldIcon, command=self.parent.changeBold)
        buttonBold.pack(side=LEFT, padx=5)

        ########################################
        self.italicIcon = PhotoImage(file='icons/italic.png')
        buttonItalic = Button(self, image=self.italicIcon, command=self.parent.changeItalic)
        buttonItalic.pack(side=LEFT, padx=5)

        ########################################
        self.underlineIcon = PhotoImage(file='icons/under_line.png')
        buttonUnderline = Button(self, image=self.underlineIcon, command=self.parent.changeUnderline)
        buttonUnderline.pack(side=LEFT, padx=5)

        ########################################
        self.fontColorIcon = PhotoImage(file='icons/color.png')
        buttonFontColor = Button(self, image=self.fontColorIcon, command=self.parent.changeFontColor)
        buttonFontColor.pack(side=LEFT, padx=5)

        ########################################
        self.alginLeftIcon = PhotoImage(file='icons/alignleft.png')
        buttonAlignLeft = Button(self, image=self.alginLeftIcon, command=self.parent.alignLeft)
        buttonAlignLeft.pack(side=LEFT, padx=5)

        ########################################
        self.alginCenterIcon = PhotoImage(file='icons/aligncenter.png')
        buttonAlignCenter = Button(self, image=self.alginCenterIcon, command=self.parent.alignCenter)
        buttonAlignCenter.pack(side=LEFT, padx=5)

        ########################################
        self.alginRightIcon = PhotoImage(file='icons/alignright.png')
        buttonAlignRight = Button(self, image=self.alginRightIcon, command=self.parent.alignRight)
        buttonAlignRight.pack(side=LEFT, padx=5)
        ...
        # Create the getFont function in the main applicaton class
        self.cbFont.bind("<<ComboboxSelected>>", self.parent.getFont)
        # Create the getFontSize function in the main applicaton class
        self.cbFontSize.bind("<<ComboboxSelected>>", self.parent.getFontSize)


# Creation of the main application bar
class MainApplication(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        # Creating widget
        self.main_menu = MainMenu(self)  # Instance
    ...
    def openFile(self, *args):
        ...
        try:
            ...
            return
        # I will get the name of my text file
        self.parent.title("NotePad - Now Editing " + str(url.split('/')[-1]))
        print(url)
    ...
    def changeBold(self, *args):
        ...
        """ 
        Overstrike size is 10 pixels, weight is normal (weight means bold or not)-if it's normal, 
        that means our text is not bold
        Underline for 0 = not underline, otherwise 1
        """
